...
> `subset3()`: the condition itself is directly expressed in the `expr()` function and then evaluated using `eval_tidy()`. This results in a more concise code but might be slightly less readable, especially in complex scenarios.
...
identical(custom_lm_wrap(I(1 / disp) + disp * cyl),
...
```{r}
custom_resample_lm <- function(formula,
                               data,
