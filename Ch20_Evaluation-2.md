...
1. The function takes the data frame df as its first argument, followed by an ellipsis (`...`) which indicates that the function can take any number of additional arguments.
