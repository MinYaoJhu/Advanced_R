...
> [.Date ensures that the output has the same class as in the input. 
> however, other attributes that a subclass might possess? They get lost:
> test is lost
...
3.  What do you expect this code to return? What does it actually return?
    ...
    # The method generic2.a1 is called. # actually, generic2.a2() is called instead.
    # The result is returned.
    
    ```

> NextMethod() doesn’t actually work with the class attribute of the object, but instead uses a special global variable (.Class) to keep track of which method to call next.
