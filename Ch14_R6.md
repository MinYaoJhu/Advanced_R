...
```
##  [1] "4♠"  "6♠"  "2♣"  "9♣"  "K♦"  "3♠"  "5♠"  "3♣"  "Q♥"  "6♣"  "A♥"  "9♠" 
## [13] "5♣"  "4♦"  "A♠"  "J♦"  "K♥"  "8♥"  "7♠"  "8♦"  "5♦"  "10♥" "Q♣"  "3♥" 
## [25] "Q♠"  "A♣"  "7♥"  "8♠"  "8♣"  "6♦"  "2♠"  "J♥"  "9♦"  "10♣" "4♣"  "J♠" 
## [37] "2♥"  "3♦"  "K♠"  "6♥"  "7♣"  "Q♦"  "5♥"  "J♣"  "4♥"  "2♦"  "10♠" "K♣" 
## [49] "9♥"  "A♦"  "7♦"  "10♦"
```
...
> To find out if private fields/methods can be accessed from subclasses, we first create a class A with a private field apple and a private method juice(). Afterwards, an instance of a subclass B is created and calls the applejuice() methods, which tries to access the apple field and the juice() method from its superclass A.
...
```r
tmp_file <- tempfile()
test_writer <- FileWriter$new(tmp_file)
